...
### Что получилось?
[Скрипт](my_ps_ax.sh), запускать который, необходимо с привилегиями SUDO. Вывод данного скрипта практически повторяет вывод команды ***ps ax***, за исключением названия некоторых значений и выравнивания. После скачивания скрипта его необходимо сделать исполняемым - ****chmod +x my_ps_ax.sh****
